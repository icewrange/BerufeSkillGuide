...
-- Nur auf deutschen Clients laden - siehe Daten_Alchimie_EN.lua für Englisch
...
BerufeGuideDB["Alchimie"] = {
    ...
    { minSkill = 110, maxSkill = 140, item = "30 Heiltrank", mats = "1 Beulengras, 1 Wilddornrose, 1 Verbleite Phiole" },
    ...
    -- FIX: Rezept nannte "Bergsilberweisling" - dieses Item existiert nicht,
    -- der korrekte deutsche Name laut Wowhead ist "Bergsilbersalbei"
    -- (Mountain Silversage). Icon-Lookup schlug bisher fehl.
    { minSkill = 285, maxSkill = 300, item = "ca. 18 Erheblicher Heiltrank", mats = "2 Goldener Sansam, 1 Bergsilbersalbei, 1 Kristallphiole" },
}
end
